...
def frontEndElement = findTestObject('Page_Transaction/name=addressShip')

def expectedText = 'KAMPUNG DATOK KERAMAT'
...
def query = 'SELECT ADDRESS_SHIP FROM transaction WHERE TRX_ID = \'01023A9AC\''
